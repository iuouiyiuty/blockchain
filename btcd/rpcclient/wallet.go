...
func (c *Client) ListUnspentMinMaxAddressesAsync4Cmd(minConf, maxConf int, addrs []string) FutureListUnspentResult {
...
func (c *Client) ListUnspentMinMaxAddresses4Cmd(minConf, maxConf int, addrs []string) ([]btcjson.ListUnspentResult, error) {
	return c.ListUnspentMinMaxAddressesAsync4Cmd(minConf, maxConf, addrs).Receive()
}
...
func (c *Client) SetTxFeeAsync(fee float64) FutureSetTxFeeResult {
	cmd := btcjson.NewSetTxFeeCmd(fee)
	return c.sendCmd(cmd)
}
...
func (c *Client) SetTxFee(fee float64) error {
...
func (c *Client) SendFromAsync(fromAccount string, toAddress string, amount float64) FutureSendFromResult {
	...
	cmd := btcjson.NewSendFromCmd(fromAccount, addr, amount.ToBTC(), nil,
		nil, nil)*/
	cmd := btcjson.NewSendFromCmd(fromAccount, toAddress, amount, nil,
		nil, nil)
	return c.sendCmd(cmd)
}
...
// NOTE: This function requires to the wallet to be unlocked.  See the
// WalletPassphrase function for more details.
func (c *Client) SendFrom(fromAccount string, toAddress string, amount float64) (*chainhash.Hash, error) {
